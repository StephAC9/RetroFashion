<template>
    ...
    <div class="product-page">
         <div style="padding: 20px">    
            ...
            <div>
                <h3>{{groupType}}</h3>
                <p>Lorem corporis eum! Quaerat facere harum quo nam voluptate ex, facilis soluta, eveniet illum laborum aperiam dolores commodi.</p>
            </div>
            <div class="filter">
              ...
              <div id="categoriesFilter" class="overlay">
                <a href="javascript:void(0)" class="closebtn" style="color: black" @click="closeFilter">&times;</a>
                <div class="overlay-content"> 
                    <CategoriesBoard  :categories="categories" class="category-overlay" :groupType="groupType"></CategoriesBoard>               
                </div>
              </div>  
            </div>
        </div> 
